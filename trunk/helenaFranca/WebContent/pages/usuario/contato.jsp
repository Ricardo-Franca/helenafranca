		...
		<div  id="contato">
			...
			<h:form>
						...
						<fieldset><legend>Contato</legend>
							<rich:dataGrid  value="#{artistaMB.buscaArtista}" columns="1" elements="1" var="artista" width="100%" cellspacing="0" cellpadding="0" border="0" style="text-align:center;">
								<h:column>	
									<table>
										<tr>
											<td>
											...
											<td width="500" align="left">
												<h:outputText style="font-weight:bold;font-size:20px;" value="#{artista.nomeArtistico}"/>
												<br/>
											    <hr>
											    <br/>												
												<h:outputText style="font-weight:bold;" value="Telefone: "/><h:outputText value="#{artista.telefone}"/>
												<br/>	
												<h:outputText style="font-weight:bold;" value="Celular: "/><h:outputText value="#{artista.celular}"/>							   				
								   				<br/><br/>
								   				<hr>								   												   					
								   				<br/>
								   				<h:outputText style="font-weight:bold;" value="E-mail: "/><h:outputText value="#{artista.email}"/>
