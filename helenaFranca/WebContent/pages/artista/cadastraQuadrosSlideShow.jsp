	...
	<f:view >
		...
		<div  id="homeArtista">						
			<h:form>
				...
				<fieldset><legend>Consulta por Quadros Do SlideShow</legend> 
				<rich:dataTable value="#{quadroMB.seusQuadros}" columns="6" var="quadroDoArtista" rows="10" id="quadrosDoArtista" width="100%" cellspacing="0" cellpadding="0" border="1" style="text-align:center;">	
					...
					<h:column>
						<f:facet name="header">
							...
							<h:column >
								<f:facet name="header">
									<h:outputText value="Cadastrar quadro no SlideShow"/>
								</f:facet>
						
								<a4j:commandLink  action="#{slideShowMB.cadastraQuadroDoSlideShow}" status="sts" reRender="quadrosDoArtista">
									<h:outputText value="Cadastrar"/>
									<f:setPropertyActionListener value="#{quadroDoArtista.codigo}" target="#{slideShowMB.codigoQuadro}" />			
								</a4j:commandLink>
							</h:column>		
				        ...
				        <h:commandButton value="Voltar" immediate="true" action="toManterSlideShow" styleClass="botoes"/>
					</fieldset>	
			</h:form>
			<br/>
