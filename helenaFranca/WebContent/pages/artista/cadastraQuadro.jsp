...
<body>
	<f:view >
		...
		<div  id="testeira">		
			...
			<fieldset>
				<fieldset>
					<legend>Cadastro de Quadros</legend>
						...
						<h:inputText id="nome" value="#{quadroMB.quadro.nome}" required="true" requiredMessage="Campo nome obrigatório!" styleClass="edit" size="30" />
						<h:message for="nome" errorClass="campoError" style="color:Red;" />
							
						<h:outputLabel for="altura" value="Altura (Centímetros)" />
						<h:inputHidden value="" />
						
						<h:inputText id="altura" value="#{quadroMB.quadro.altura}" required="true" requiredMessage="Campo altura obrigatório!" styleClass="edit" size="3" />
						<h:message for="altura" errorClass="campoError" style="color:Red;" />
						
						<h:outputLabel for="largura" value="Largura (Centímetros)" />
						<h:inputHidden value="" />
						
						<h:inputText id="largura" value="#{quadroMB.quadro.largura}" required="true" requiredMessage="Campo largura obrigatório!" styleClass="edit" size="3" />
						<h:message for="largura" errorClass="campoError" style="color:Red;" />
						
						<h:outputLabel for="peso" value="Peso Kg" />
						<h:inputHidden value="" />
						
						<h:inputText id="peso" value="#{quadroMB.quadro.peso}" required="true" requiredMessage="Campo peso obrigatório!" styleClass="edit" size="4" >
						...
						<h:inputText id="preco" value="#{quadroMB.quadro.preco}" size="4" required="true" requiredMessage="Campo preço obrigatório!">
						...
						<h:selectOneMenu id="categoria" value="#{quadroMB.quadro.categoria.codigo}" required="true"
				...
				<fieldset>
							<a4j:commandButton value="Cadastrar" action="#{quadroMB.save}" status="sts" reRender="erros,inputs" />
